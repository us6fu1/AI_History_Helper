...
def detect_chat_format(model_path: str) -> Optional[str]:
    ...
    Покрывает популярные fine-tune'ы (Saiga / Vikhr / T-lite / Hermes),
...
class ModelRegistry:
    ...
    RECOMMENDED = [
        ...
        {
            "name": "T-lite-it-1.0 (8B Q4_K_M) — русский от Т-Банка",
            "description": (
                "Т-Банк, fine-tune Llama-3 8B. ~4.7 GB, ~3.5 ток/с. "
                "Русский ≈ Saiga, чуть лучше для деловых/официальных "
                "формулировок."
            ),
            "url": "https://huggingface.co/t-tech/T-lite-it-1.0-GGUF",
